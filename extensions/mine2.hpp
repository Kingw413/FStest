#ifndef NFD_DAEMON_FW_MINE2_HPP
#define NFD_DAEMON_FW_MINE2_HPP
...
public:
	explicit MINE2(Forwarder &forwarder, const Name &name = getStrategyName());
...
afterReceiveLoopedInterest(const FaceEndpoint& ingress, const Interest& interest,
    ...
    bool
    isInPath(ns3::Ptr<ns3::Node> node, ns3::Ptr<ns3::Node> desNode);
...
private:
	...
	std::vector<MINE2::neighborTableEntry> m_NT;
