 ...
 */
class WifiNetDeviceTransportBroadcast : public nfd::face::Transport
{
public:
  WifiNetDeviceTransportBroadcast(Ptr<Node> node, const Ptr<WifiNetDevice>& netDevice,
  ...
  ~WifiNetDeviceTransportBroadcast();
